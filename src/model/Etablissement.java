...
public class Etablissement {
	...
	public double getPollution(String polluant, int annee) {
	    switch (polluant) {
	        case "NO2":
	            return polluStatNO2.get(annee);
	        case "PM10":
	        ...
	        case "PM25":
	            return polluStatPM25.get(annee);
	        default:
	            throw new IllegalArgumentException("Polluant non valide : " + polluant);
	    }
	}
	public double getDistance() {
		distance = coordonnees.distanceToParis();
		return distance;
	}
